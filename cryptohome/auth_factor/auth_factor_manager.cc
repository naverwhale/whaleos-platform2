...
AuthFactorMap AuthFactorManager::LoadAllAuthFactors(
  ...
  auto label_to_auth_factor = LoadAllAuthFactorsInternal(
      obfuscated_username, uss_labels, converter, false /* is_backup */);
  ...
  return LoadAllAuthFactorsInternal(
      obfuscated_username, uss_labels, converter, true /* is_backup */);
}
...
AuthFactorManager::LabelToTypeMap AuthFactorManager::ListAuthFactors(
  ...
  std::unique_ptr<FileEnumerator> file_enumerator(platform_->GetFileEnumerator(
      AuthFactorsDirPath(obfuscated_username
        , is_backup
        ), /*recursive=*/false,
