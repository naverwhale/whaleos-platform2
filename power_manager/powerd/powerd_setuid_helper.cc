...
const std::string kStatefulPartitionPath = "/mnt/stateful_partition/unencrypted/";
const std::string kDownloadsDirPath = "/home/chronos/user/Downloads/";
const std::string kImageloaderDirPath = "/run/imageloader/andruntime-dlc/package/root/";
